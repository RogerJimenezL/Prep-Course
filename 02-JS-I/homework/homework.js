...
function suma(x, y) {
  ...
  var sumarespuesta = x + y;

  return sumarespuesta;
...
function resta(x, y) {
  ...
  // Tu código:
  var restarespuesta = x - y;

  return restarespuesta;
...
function divide(x, y) {
  ...
  var dividerespuesta = x / y;

  return dividerespuesta;
